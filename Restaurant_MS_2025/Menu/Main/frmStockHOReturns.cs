...
{
    public partial class frmStockHOReturns : Form
    {
        ...
        private void frmManageStocks_Load(object sender, EventArgs e)
        {
            ...
            SharedFunctions.SetLarggeButtonsStyle(new[] { btnRefresh, btnAddNewReturn });
            LoadAdjustments();
        ...
        private void LoadAdjustments()
        {
            ...
            using (unitOfWork = new UnitOfWork())
            {
                ...
                {
                    AdjustmentList = unitOfWork.AdjustmentRepository.GetAdjustments(dtpFrom.Value, dtpTo.Value, pageNo, SharedVariables.PageSize, Enums.AdjustmentType.HOReturn);
                }
                else if (filter == FilterType.Item)
                {
                    AdjustmentList = unitOfWork.AdjustmentRepository.GetAdjustments(this.SelectedItemId, this.pageNo, SharedVariables.PageSize, Enums.AdjustmentType.HOReturn);
                }
                else if (filter == FilterType.Default)
                {
                    AdjustmentList = unitOfWork.AdjustmentRepository.GetAdjustments(pageNo, SharedVariables.PageSize, Enums.AdjustmentType.HOReturn);
                }
            }
        ...
        private void BuildPanel(Adjustment a)
        {
            ...
            foreach (AdjustmentItem i in a.AdjustmentItems)
            {
                if (i.IsActive)
                {
                    ...
                    grdItem.Rows.Add(i.Item.ItemId, i.Item.ItemName, i.Batch.BatchName, "i.UnitString", i.Quantity * -1, i.Reason, i.CreatedAt);
                }
            }
            SharedFunctions.SetGridStyle(grdItem);
            // 
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Form f = SharedFunctions.OpenForm(new frmStockHOReturn(Adjustment), this.MdiParent);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                DialogResult rs = MessageBox.Show("Are You Sure, You Want to Delete This stock return", "Please Make Sure", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
                ...
                MessageBox.Show("Stock return Deleted Successfully", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                btnRefresh.PerformClick();
            }
            catch (Exception ex)
            {
        ...
        {
            long Adjustment = (long)((Button)sender).Tag;
            //Reports.StockHOReturnViewer v = new Reports.StockHOReturnViewer(Adjustment);
            //v.Show();
        }
        ...
        {
            ShortCutDialogs.frmStockHOReturnsShortCuts f = new ShortCutDialogs.frmStockHOReturnsShortCuts();
            f.ShowDialog();
        }
        ...
        {
            SharedFunctions.OpenForm(new frmStockHOReturn(), this.MdiParent);
        }
