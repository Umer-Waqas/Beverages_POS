...
{
    public partial class ProfitMarginViewer : Form
    {
        int Orientation = 0;
        UnitOfWork unitOfWork;
        List<ProfitMarginVM> pmLis;
        long SupplierId = 0;
        public ProfitMarginViewer()
        {
            InitializeComponent();
        }

         public ProfitMarginViewer(int Orientation)
        {
            InitializeComponent();
            this.Orientation = Orientation;            
        }

         public ProfitMarginViewer(int Orientation, List<ProfitMarginVM> pmLis)
        {
            InitializeComponent();
            this.Orientation = Orientation;
            this.pmLis = pmLis;
        ...
        private void LowStocsViewer_Load(object sender, EventArgs e)
        {
            ...
            {               
                if (Orientation == 0)
                {
                    Reports.Product.ProfitMarginRpt_Portrait r = new ProfitMarginRpt_Portrait();
