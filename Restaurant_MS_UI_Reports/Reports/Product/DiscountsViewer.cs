...
namespace Pharmacy.UI.Reports.Product
{
    public partial class DiscountsViewer : Form
    {
        ...
        public DiscountsViewer()
        {
         ...
         public DiscountsViewer(int Orientation)
        {
            InitializeComponent();
            this.Orientation = Orientation;            
        }

         public DiscountsViewer(int Orientation, List<FlatDiscountVM> pmLis)
        {
            InitializeComponent();
            this.Orientation = Orientation;
            this.pmLis = pmLis;
        ...
        private void LowStocsViewer_Load(object sender, EventArgs e)
        {
            ...
            {               
                if (Orientation == 0)
                {
                    Reports.Product.DiscountsRpt_Portrait r = new DiscountsRpt_Portrait();
